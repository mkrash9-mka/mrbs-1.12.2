...
// to be an admin)
{
  ...
  if (!isset($action) && !$is_ajax)   // second time through it will be set to "update"
  {
    $action = "add";
    $id = null;
  }
